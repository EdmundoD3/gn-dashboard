...
import { handleSubmit, setHandleChange, setArrayValues } from "../Handle/handle";
...
const DropboxState = DropBoxUrl({ url: `${urlVersion}/state`, fetchParam: "state", labelName: "Estado" })
const DropboxColonia = DropBoxUrl({ url: `${urlVersion}/colonia`, fetchParam: "colonia", labelName: "Colonia" })
const DropboxCity = DropBoxUrl({ url: `${urlVersion}/city`, fetchParam: "city", labelName: "Ciudad" })
