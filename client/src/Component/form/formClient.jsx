...
const Dropboxstatus = DropBoxUrl({ url: `${urlVersion}/status`, fetchParam: "status", labelName: "Status" })
const DropboxVendedora = DropBoxUrl({ url: `${urlVersion}/vendedora`, fetchParam: "vendedora", labelName: "Vendedora" })
