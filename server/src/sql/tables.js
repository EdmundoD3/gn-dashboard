const tables = {
  pagos: 'CREATE TABLE IF NOT EXISTS `pagos` (\
    ...
    PRIMARY KEY (`id` AUTOINCREMENT),\
      ...
      ON DELETE NO ACTION\
      ON UPDATE NO ACTION);',
  addres: 'CREATE TABLE IF NOT EXISTS `addres` (\
    `id` INTEGER NOT NULL UNIQUE,\
  ...
  cliente: 'CREATE TABLE IF NOT EXISTS `cliente` (\
    ...
    PRIMARY KEY (`id` AUTOINCREMENT),\
      ...
      ON DELETE NO ACTION\
      ON UPDATE NO ACTION)',
  cobrador: 'CREATE TABLE IF NOT EXISTS `cobrador` (\
    `id` INTEGER NOT NULL UNIQUE,\
    `cobrador` TEXT NOT NULL UNIQUE,\
    PRIMARY KEY (`id` AUTOINCREMENT))',
  colonia: 'CREATE TABLE IF NOT EXISTS `colonia` (\
    `id` INTEGER NOT NULL UNIQUE,\
  ...
  compra: 'CREATE TABLE IF NOT EXISTS `compra` (\
    ...
    PRIMARY KEY (`id` AUTOINCREMENT),\
      ...
      ON DELETE NO ACTION\
      ON UPDATE NO ACTION)',
  cuenta: 'CREATE TABLE IF NOT EXISTS `cuenta` (\
    `id` INTEGER NOT NULL UNIQUE,\
    `cliente_id` INTEGER NOT NULL,\
  ...
  status: 'CREATE TABLE IF NOT EXISTS `status` (\
    ...
    PRIMARY KEY (`id` AUTOINCREMENT))',
  vendedora: 'CREATE TABLE IF NOT EXISTS `vendedora` (\
    `id` INTEGER NOT NULL UNIQUE,\
